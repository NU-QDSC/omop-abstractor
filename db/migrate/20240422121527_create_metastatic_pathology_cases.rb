class CreateMetastaticPathologyCases < ActiveRecord::Migration[5.2]
  def change
    create_table :metastatic_pathology_cases do |t|
      ...
      t.text    :has_cancer_histology_suggestion_match_values, null: true
      ...
      t.text    :has_cancer_site_suggestion_sentences, null: true

      t.string  :has_metastatic_cancer_primary_site, null: true
      t.text    :has_metastatic_cancer_primary_site_suggestions, null: true
      t.text    :has_metastatic_cancer_primary_site_suggestion_sentences, null: true
