...
(
 ...
 has_tumor_size                               varchar(255)  NULL,
 ...
 has_estrogen_receptor_status                 varchar(255)  NULL,
 has_progesterone_receptor_status             varchar(255)  NULL,
 has_her2_status                              varchar(255)  NULL,
 has_lymphovascular_invasion                  varchar(255)  NULL,
...
INSERT INTO cancer_abstractions (
 ...
 , has_estrogen_receptor_status
 , has_progesterone_receptor_status
 , has_her2_status
...
SELECT note_stable_identifier.id
     ...
     , pivoted_abstractions.has_tumor_size
     ...
     , pivoted_abstractions.has_estrogen_receptor_status
     , pivoted_abstractions.has_progesterone_receptor_status
     , pivoted_abstractions.has_her2_status
     , pivoted_abstractions.has_lymphovascular_invasion
...
FROM note_stable_identifier JOIN note_stable_identifier_full ON note_stable_identifier.stable_identifier_path = note_stable_identifier_full.stable_identifier_path AND note_stable_identifier.stable_identifier_value = note_stable_identifier_full.stable_identifier_value
     LEFT JOIN (SELECT note_stable_identifier.id AS subject_id,
                       Max(CASE
                             WHEN data.predicate = 'has_tumor_size' THEN
                             data.value
                             ELSE NULL
                           END)                  AS has_tumor_size,
                       Max(CASE
                       ...
                       Max(CASE
                             WHEN data.predicate = 'has_estrogen_receptor_status' THEN
                             data.value
                             ELSE NULL
                           END)                  AS has_estrogen_receptor_status,
                       Max(CASE
                             WHEN data.predicate = 'has_progesterone_receptor_status' THEN
                             data.value
                             ELSE NULL
                           END)                  AS has_progesterone_receptor_status,
                       Max(CASE
                             WHEN data.predicate = 'has_her2_status' THEN data.value
                             ELSE NULL
                           END)                  AS has_her2_status,
                       Max(CASE
                             WHEN data.predicate = 'has_lymphovascular_invasion' THEN data.value
                             ELSE NULL
                           END)                  AS has_lymphovascular_invasion,
                       Max(CASE
...
(
  ...
  has_cancer_pathologic_sbr_grade          varchar(255)  NULL,
...
INSERT INTO cancer_diagnosis_abstractions (
 ...
 , has_cancer_pathologic_sbr_grade
...
SELECT note_stable_identifier.id
     ...
     , pivoted_abstractions.has_cancer_pathologic_sbr_grade
...
FROM note_stable_identifier JOIN note_stable_identifier_full ON note_stable_identifier.stable_identifier_path = note_stable_identifier_full.stable_identifier_path AND note_stable_identifier.stable_identifier_value = note_stable_identifier_full.stable_identifier_value
      JOIN (SELECT note_stable_identifier.id AS subject_id,
                   ...
                   Max(CASE
                         WHEN data.predicate = 'has_cancer_pathologic_sbr_grade' THEN
                         data.value
                         ELSE NULL
                       END)                  AS has_cancer_pathologic_sbr_grade,
                   Max(CASE
...
--inside
INSERT INTO breast_pathology_cases
(
  abstractor_namespace_name
, west_mrn
