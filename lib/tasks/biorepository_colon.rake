...
require 'csv'
namespace :biorepository_colon do
  desc 'Load schemas CLAMP biorepository Colon'
  task(schemas_clamp_biorepository_colon: :environment) do |t, args|
    ...
    colon_histologies = Icdo3Histology.by_primary_colon
    colon_histologies.each do |histology|
    ...
    colon_sites = Icdo3Site.by_primary_colon
    colon_sites.each do |site|
    ...
    abstractor_object_value = abstractor_abstraction_schema.abstractor_object_values.where(vocabulary_code: 'C18.9').first #colon (c18.9)
    abstractor_object_value.favor_more_specific = true
    abstractor_object_value.save!
    ...
    sites = Icdo3Site.by_primary_metastatic_colon
    sites.each do |site|
    ...
    abstractor_object_value = Abstractor::AbstractorObjectValue.where(value: 'pN2a', vocabulary_code: 'pN2a').first_or_create
    Abstractor::AbstractorAbstractionSchemaObjectValue.where(abstractor_abstraction_schema: abstractor_abstraction_schema, abstractor_object_value: abstractor_object_value).first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_pN2a').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: 'N2a').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_N2a').first_or_create

    abstractor_object_value = Abstractor::AbstractorObjectValue.where(value: 'pN2b', vocabulary_code: 'pN2b').first_or_create
    Abstractor::AbstractorAbstractionSchemaObjectValue.where(abstractor_abstraction_schema: abstractor_abstraction_schema, abstractor_object_value: abstractor_object_value).first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_pN2b').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: 'N2b').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_N2b').first_or_create
    ...
    abstractor_object_value = Abstractor::AbstractorObjectValue.where(value: 'ypN2a', vocabulary_code: 'ypN2a').first_or_create
    Abstractor::AbstractorAbstractionSchemaObjectValue.where(abstractor_abstraction_schema: abstractor_abstraction_schema, abstractor_object_value: abstractor_object_value).first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_ypN2a').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: 'yN2a').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_yN2a').first_or_create

    abstractor_object_value = Abstractor::AbstractorObjectValue.where(value: 'ypN2b', vocabulary_code: 'ypN2b').first_or_create
    Abstractor::AbstractorAbstractionSchemaObjectValue.where(abstractor_abstraction_schema: abstractor_abstraction_schema, abstractor_object_value: abstractor_object_value).first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_ypN2b').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: 'yN2b').first_or_create
    Abstractor::AbstractorObjectValueVariant.where(abstractor_object_value: abstractor_object_value, value: '_yN2b').first_or_create
    #end ypn
  ...
  desc "Clamp Dictionary Biorepository Colon"
  task(clamp_dictionary_biorepository_colon: :environment) do  |t, args|
    dictionary_items = []
    ...
    File.open 'lib/setup/data_out/abstractor_clamp_biorepository_colon_data_dictionary.txt', 'w' do |f|
  ...
  desc "Load Biorepository Colon data"
  task(biorepository_colon_data: :environment) do |t, args|
    files = ['lib/setup/data/biorepository_colon/Specimen Collection Facility Pathology Cases with Surgeries 1.xlsx', 'lib/setup/data/biorepository_colon/Specimen Collection Facility Pathology Cases with Surgeries 2.xlsx']
  ...
  desc "Biorepository Colon output"
  task(output: :environment) do |t, args|
    insert = "INSERT INTO #abstractions (abstractor_namespace_name, stable_identifier_path, stable_identifier_value, has_cancer_histology, has_cancer_histology_suggestions, has_cancer_site, has_cancer_site_suggestions, has_cancer_site_laterality, has_cancer_pathologic_grade, has_cancer_recurrence_status, has_metastatic_cancer_histology, has_metastatic_cancer_histology_suggestions, has_metastatic_cancer_site, has_metastatic_cancer_site_suggestions, has_metastatic_cancer_primary_site, has_metastatic_cancer_site_laterality, has_metastatic_cancer_recurrence_status, has_surgery_date, pathological_tumor_staging_category, pathological_nodes_staging_category, pathological_metastasis_staging_category, has_tumor_size) SELECT "
    inserts = []
    pathology_cases = CSV.new(File.open('lib/setup/data/biorepository_colon/output/colon.csv'), headers: true, col_sep: ",", return_headers: false,  quote_char: "\"")
    pathology_cases.each do |pathology_case|
      insert += "'#{pathology_case['abstractor_namespace_name']}', "
      insert += "'#{pathology_case['stable_identifier_path']}', "
      insert += "'#{pathology_case['stable_identifier_value']}', "
      insert += "'#{pathology_case['has_cancer_histology']}', "
      insert += "'#{pathology_case['has_cancer_histology_suggestions']}', "
      insert += "'#{pathology_case['has_cancer_site']}', "
      insert += "'#{pathology_case['has_cancer_site_suggestions']}', "
      insert += "'#{pathology_case['has_cancer_site_laterality']}', "
      insert += "'#{pathology_case['has_cancer_pathologic_grade']}', "
      insert += "'#{pathology_case['has_cancer_recurrence_status']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_histology']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_histology_suggestions']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_site']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_site_suggestions']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_primary_site']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_site_laterality']}', "
      insert += "'#{pathology_case['has_metastatic_cancer_recurrence_status']}', "
      insert += "'#{pathology_case['has_surgery_date']}', "
      insert += "'#{pathology_case['pathological_tumor_staging_category']}', "
      insert += "'#{pathology_case['pathological_nodes_staging_category']}', "
      insert += "'#{pathology_case['pathological_metastasis_staging_category']}', "
      insert += "'#{pathology_case['has_tumor_size']}';"
      inserts << insert
    end

    File.open 'lib/setup/data/biorepository_colon/output/colon_output.txt', 'w' do |f|
