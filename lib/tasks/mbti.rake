...
namespace :mbti do
  ...
  task(mbti_data: :environment) do |t, args|
    files = ['lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 1.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 2.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 3.xlsx', 'lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 4.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 5.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 6.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 7.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 8.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 9.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 10.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 11.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 12.xlsx', 'lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 13.xlsx', 'lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 14.xlsx', 'lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 15.xlsx', 'lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 16.xlsx','lib/setup/data/mbti/Pathology Cases with Surgeries V2 MBTI Upgrade 17.xlsx']
