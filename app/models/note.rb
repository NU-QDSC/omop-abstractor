class Note < ApplicationRecord
  ...
  def other_notes(options ={})
    ...
    NoteStableIdentifier.search_across_fields(nil, nil, nil, nil, nil, {}).where('note.person_id = ? AND note.note_id != ?', self.person_id, self.note_id).by_abstractor_abstraction_status(abstractor_abstraction_status, namespace_type: namespace_type, namespace_id: namespace_id)
  end
